...
@with_transaction
def populate_db():
    g1 = Group.create(id=1, dep='dep1')
    g2 = Group.create(id=2, dep='dep2')
    ...
    c1 = Course.create(id=10, name='Math')
    c2 = Course.create(id=11, name='Economics')
    c3 = Course.create(id=12, name='Physics')
    Grade.create(student=s1, course=c1, value='C')
    Grade.create(student=s1, course=c3, value='A')
    Grade.create(student=s2, course=c2, value='B')
    r1 = Room.create(name='Room1')
    r2 = Room.create(name='Room2')
    r3 = Room.create(name='Room3')
    g1.rooms = [ r1, r2 ]
    g2.rooms = [ r2, r3 ]
populate_db()
