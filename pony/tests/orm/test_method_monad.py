...
@with_transaction
def populate_db():
    Student.create(1, name="Joe", scholarship=None);
    Student.create(2, name=" Bob ", scholarship=100);
    Student.create(3, name=" Beth ", scholarship=500);
    Student.create(4, name="Jon", scholarship=500);
    Student.create(5, name="Pete", scholarship=700);
populate_db()
