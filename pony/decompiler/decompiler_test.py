...
class TestDecompiler:
    ...
    def test_2(self):
        ...
        expected = "['w', 'd', 's'] for t in .0 if ((((4 != x.amount) or ((amount * 3 > 20) or (amount * 2 < 5)))) and (amount * 8 == 20))"
        result = decompile_tostring(g)
        assert result == expected
    ...
    def test_4(self):
        ...
        expected = "['w', 'd', 's'] for t in .0 if ((4 != x.a) or ((a * 3 > 20) or ((a * 2 < 5) and (a * 8 == 20))))"
        result = decompile_tostring(g)
        assert result == expected

    def test_5(self):
        g =        ( (s,d,w) for t in Student   if ( 4 != x.a  or  a * 3 > 20 ) and ( a * 2 < 5  or  a * 8 == 20 ))
        expected = "['w', 'd', 's'] for t in .0 if ((((4 != x.a) or (a * 3 > 20))) and ((a * 2 < 5) or (a * 8 == 20)))"
        result = decompile_tostring(g)
        assert result == expected
    ...
    def test_7(self):
        ...
        expected = "['w', 't', 's'] for t in .0 if ((((((4 != x.a.b) or ((a * 3 > 20) or ((a * 2 < 5) and (v == 6))))) and (a * 8 == 20))) or (f > 4))"
        result = decompile_tostring(g)
        assert result == expected
