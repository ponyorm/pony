    ...
    def decorator(func):
        def wrapper(self, *args, **kwargs):
            try:
                ...
                self.fail("expected exception %s wasn't raised" %
                          exc_class.__name__)
                ...
                if not e.args:
                    ...
                    self.assertEqual(e.args[
                                     0], msg, "incorrect exception message. expected '%s', got '%s'" % (msg, e.args[0]))
